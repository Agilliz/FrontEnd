        ...
        <div className="flex w-full">
          <div className="w-1/2 flex justify-center items-center p-3 pb-0 flex-col mb-7">
            <ContainerDash
              ...
              idChart="chart-bar"
              grafico={<GraficoBar altura={180} data={[50, 60, 70]} categories={["Lucro Bruto", "Lucro Líquido", "Taxas e Impostos"]}/>}
            />         
          ...
          <div className="w-1/2 flex justify-center items-center p-3 pb-0 flex-col mb-7">
            <ContainerDash
              ...
              idChart="chart-linha"
              grafico={<GraficoLinha altura={180} data={[45, 54, 54, 54, 54, 54, 54, 54]}/>}
            />

...
const Dropdown = ({ submenus, dropdown }) => {
  return (
    <ul
      className={`dropdown w-full ${dropdown ? "show active" : ""} font-normal`}
    >
      {submenus &&
        submenus.map((submenu, index) => (
          <li key={index} className="menu-items ml-1 pt-1 flex justify-left">
          <svg width="20" height="20" viewBox="0 0 27 30" fill="none" xmlns="http://www.w3.org/2000/svg" className="mr-3">
